 ...
 */
@SectionName( BrokenMetricsConfig.SECTION )
@ApplicationScoped
public class BrokenMetricsConfig
{
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ELKREPORTER_PREFIX )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ELKREPORTER_SIMPLE_PERIOD )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ELKREPORTER_JVM_PERIOD )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ELKREPORTER_HEALTHCHECK_PERIOD )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ELKREPORTER_HOSTS )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ELKREPORTER_INDEX )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ZABBIXREPORTER_PREFIX )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ZABBIXREPORTER_SIMPLE_PERIOD )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ZABBIXREPORTER_JVM_PERIOD )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ZABBIXREPORTER_HEALTHCHECK_PERIOD )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ZABBIXREPORTER_API_HOST_URL )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ZABBIXREPORTER_HOST )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ZABBIXREPORTER_HOST_PORT )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ZABBIXREPORTER_USER )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ZABBIXREPORTER_PWD )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ZABBIXREPORTER_LOCAL_HOSTNAME )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_ISENABLED )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_ISENABLED )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_GRPHITEREPORTER_HOSTNAME )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_GRPHITEREPORTER_PORT )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_GRPHITEREPORTER_PREFIX )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_GRPHITEREPORTER_SIMPLE_PERIOD )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_GRPHITEREPORTER_JVM_PERIOD )
    ...
    @ConfigName( BrokenMetricsConfig.INDY_METRICS_REPORTER_GRPHITEREPORTER_HEALTHCHECK_PERIOD )
