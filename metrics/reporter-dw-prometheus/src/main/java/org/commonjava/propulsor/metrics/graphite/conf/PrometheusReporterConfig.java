...
@ApplicationScoped
@SectionName( "metrics.dropwizard.prometheus" )
public class PrometheusReporterConfig
        extends ReporterConfiguration<PrometheusReporterConfig>
{
    public static final String DEFAULT_CONTEXT_PATH = "/metrics";
